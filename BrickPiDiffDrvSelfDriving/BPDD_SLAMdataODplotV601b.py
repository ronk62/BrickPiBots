...
while (True):        
    ...
    if x == 108: # l pushed - loading sample data from csv files
        ...
        # load from csv files
        polarCoordsUSr = np.loadtxt('polarCoordsUSrV601b-13.csv', delimiter=',')
        polarCoordsIRr = np.loadtxt('polarCoordsIRrV601b-13.csv', delimiter=',')
        ODmRencoderVal = np.loadtxt('ODmRencoderValV601b-13.csv', delimiter=',')
        #ODcmpDeg = np.loadtxt('ODcmpDegV601b.csv', delimiter=',')
        polarCoordscmpDeg = np.loadtxt('polarCoordscmpDegV601b-13.csv', delimiter=',')
