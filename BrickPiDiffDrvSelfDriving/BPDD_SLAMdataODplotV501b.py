...
while (True):        
    ...
    if x == 108: # l pushed - loading sample data from csv files
        ...
        # load from csv files
        polarCoordsUSr = np.loadtxt('polarCoordsUSrV501b-10.csv', delimiter=',')
        polarCoordsIRr = np.loadtxt('polarCoordsIRrV501b-10.csv', delimiter=',')
        ODmRencoderVal = np.loadtxt('ODmRencoderValV501b-10.csv', delimiter=',')
        #ODcmpDeg = np.loadtxt('ODcmpDegV601b.csv', delimiter=',')
        polarCoordscmpDeg = np.loadtxt('polarCoordscmpDegV501b-10.csv', delimiter=',')
