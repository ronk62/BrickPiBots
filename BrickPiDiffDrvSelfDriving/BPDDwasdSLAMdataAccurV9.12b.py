...
### Main Loop
    while (True):
        ...
        if x == 108: # l pushed - loading sample data from csv files
            ...
            # load from csv files
            polarCoordsUSmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsUSmean-V912b-8.csv', delimiter=',')
            polarCoordsUSstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsUSstd-V912b-8.csv', delimiter=',')
            polarCoordsir1rmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1rmean-V912b-8.csv', delimiter=',')
            polarCoordsir1rstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1rstd-V912b-8.csv', delimiter=',')
            polarCoordsir1hmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1hmean-V912b-8.csv', delimiter=',')
            polarCoordsir1hstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1hstd-V912b-8.csv', delimiter=',')            
            polarCoordsir2rmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2rmean-V912b-8.csv', delimiter=',')
            polarCoordsir2rstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2rstd-V912b-8.csv', delimiter=',')
            polarCoordsir2hmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2hmean-V912b-8.csv', delimiter=',')
            polarCoordsir2hstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2hstd-V912b-8.csv', delimiter=',')            
            polarCoordscmpMean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordscmpMean-V912b-8.csv', delimiter=',')
