    ...
    while (True):
        ...
        if x == 102: # f pushed - save sample statistics to file
            ...
            if polarCoordsUSmean.size < 1 or polarCoordsUSstd.size < 1 or polarCoordsir1rmean.size < 1 or polarCoordsir1rstd.size < 1 or polarCoordscmpMean.size < 1:
                ...
                # save to csv files
                np.savetxt('polarCoordsUSmean-V912b-12.csv', polarCoordsUSmean, delimiter=',')
                np.savetxt('polarCoordsUSstd-V912b-12.csv', polarCoordsUSstd, delimiter=',')
                np.savetxt('polarCoordsir1rmean-V912b-12.csv', polarCoordsir1rmean, delimiter=',')
                np.savetxt('polarCoordsir1rstd-V912b-12.csv', polarCoordsir1rstd, delimiter=',')
                np.savetxt('polarCoordsir1hmean-V912b-12.csv', polarCoordsir1hmean, delimiter=',')
                np.savetxt('polarCoordsir1hstd-V912b-12.csv', polarCoordsir1hstd, delimiter=',')
                np.savetxt('polarCoordsir2rmean-V912b-12.csv', polarCoordsir2rmean, delimiter=',')
                np.savetxt('polarCoordsir2rstd-V912b-12.csv', polarCoordsir2rstd, delimiter=',')
                np.savetxt('polarCoordsir2hmean-V912b-12.csv', polarCoordsir2hmean, delimiter=',')
                np.savetxt('polarCoordsir2hstd-V912b-12.csv', polarCoordsir2hstd, delimiter=',')
                np.savetxt('polarCoordscmpMean-V912b-12.csv', polarCoordscmpMean, delimiter=',')
        ...
        if x == 108: # l pushed - loading sample data from csv files
            ...
            # load from csv files
            polarCoordsUSmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsUSmean-V912b-12.csv', delimiter=',')
            polarCoordsUSstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsUSstd-V912b-12.csv', delimiter=',')
            polarCoordsir1rmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1rmean-V912b-12.csv', delimiter=',')
            polarCoordsir1rstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1rstd-V912b-12.csv', delimiter=',')
            polarCoordsir1hmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1hmean-V912b-12.csv', delimiter=',')
            polarCoordsir1hstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1hstd-V912b-12.csv', delimiter=',')            
            polarCoordsir2rmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2rmean-V912b-12.csv', delimiter=',')
            polarCoordsir2rstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2rstd-V912b-12.csv', delimiter=',')
            polarCoordsir2hmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2hmean-V912b-12.csv', delimiter=',')
            polarCoordsir2hstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2hstd-V912b-12.csv', delimiter=',')            
            polarCoordscmpMean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordscmpMean-V912b-12.csv', delimiter=',')
