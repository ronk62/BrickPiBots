    ...
    while (True):
        ...
        if x == 102: # f pushed - save sample statistics to file
            ...
            if polarCoordsUSmean.size < 1 or polarCoordsUSstd.size < 1 or polarCoordsir1rmean.size < 1 or polarCoordsir1rstd.size < 1 or polarCoordscmpMean.size < 1:
                ...
                # save to csv files
                np.savetxt('polarCoordsUSmean-V912b-5.csv', polarCoordsUSmean, delimiter=',')
                np.savetxt('polarCoordsUSstd-V912b-5.csv', polarCoordsUSstd, delimiter=',')
                np.savetxt('polarCoordsir1rmean-V912b-5.csv', polarCoordsir1rmean, delimiter=',')
                np.savetxt('polarCoordsir1rstd-V912b-5.csv', polarCoordsir1rstd, delimiter=',')
                np.savetxt('polarCoordsir1hmean-V912b-5.csv', polarCoordsir1hmean, delimiter=',')
                np.savetxt('polarCoordsir1hstd-V912b-5.csv', polarCoordsir1hstd, delimiter=',')
                np.savetxt('polarCoordsir2rmean-V912b-5.csv', polarCoordsir2rmean, delimiter=',')
                np.savetxt('polarCoordsir2rstd-V912b-5.csv', polarCoordsir2rstd, delimiter=',')
                np.savetxt('polarCoordsir2hmean-V912b-5.csv', polarCoordsir2hmean, delimiter=',')
                np.savetxt('polarCoordsir2hstd-V912b-5.csv', polarCoordsir2hstd, delimiter=',')
                np.savetxt('polarCoordscmpMean-V912b-5.csv', polarCoordscmpMean, delimiter=',')
        ...
        if x == 108: # l pushed - loading sample data from csv files
            ...
            # load from csv files
            polarCoordsUSmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsUSmean-V902b-3.csv', delimiter=',')
            polarCoordsUSstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsUSstd-V902b-3.csv', delimiter=',')
            polarCoordsir1rmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1rmean-V902b-3.csv', delimiter=',')
            polarCoordsir1rstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1rstd-V902b-3.csv', delimiter=',')
            polarCoordsir1hmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1hmean-V902b-3.csv', delimiter=',')
            polarCoordsir1hstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir1hstd-V902b-3.csv', delimiter=',')            
            polarCoordsir2rmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2rmean-V902b-3.csv', delimiter=',')
            polarCoordsir2rstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2rstd-V902b-3.csv', delimiter=',')
            polarCoordsir2hmean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2hmean-V902b-3.csv', delimiter=',')
            polarCoordsir2hstd = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordsir2hstd-V902b-3.csv', delimiter=',')            
            polarCoordscmpMean = np.loadtxt('/home/robot/ev3dev2Projects/polarCoordscmpMean-V902b-3.csv', delimiter=',')
            ...
            print("smoothing the polarCoordsir1hmean array data...")
            print("")
            # 7 point rolling avg (n-3, n-2, n-1, n, n+1, n+2, n+3)
            ...
            for i in range(0,len(polarCoordsir1rmean)):
                #j = (polarCoordsir1rmean[i-3] + polarCoordsir1rmean[i-2] + polarCoordsir1rmean[i-1] + polarCoordsir1rmean[i] + polarCoordsir1rmean[i+1] + polarCoordsir1rmean[i+2] + polarCoordsir1rmean[i+3]) / 7
                taken = np.take(polarCoordsir1rmean,[i-3, i-2, i-1, i, i+1, i+2, i+3], mode='wrap')
                #print("taken = ", taken)
                k = 0
            ...
            for i in range(0,len(polarCoordsUSmean)):
                if polarCoordsir1rmean[i] <= 310 and polarCoordsir1hstd[i] <= 3:    # needs tuning
                    # find value closest to +5
                    if polarCoordsir1hmean[i] > 3 and polarCoordsir1hmean[i] < 9:    # needs tuning
                        ...
                        if abs(5 - new_plus5ir1hangle) < abs(5 - plus5ir1hangle):
                            ...
                            print("polarCoordsir1hmean[i] = ", polarCoordsir1hmean[i])
                            print("polarCoordsir1hstd[i] = ", polarCoordsir1hstd[i])
                    # find value closest to 0
                    if polarCoordsir1hmean[i] <= 3 and polarCoordsir1hmean[i] >= -3:    # needs tuning
                        ...
                        if abs(0 - new_zeroir1hangle) < abs(0 - zeroir1hangle):
                            ...
                            print("polarCoordsir1hstd[i] = ", polarCoordsir1hstd[i])
                    # find value closest to -5
                    if polarCoordsir1hmean[i] > -9 and polarCoordsir1hmean[i] < -3:    # needs tuning
