...
# 6/9/2020      Ron King    - used file /home/robot/ev3dev2Projects/MineLoaderSelfDriving/MLwasdSLAMtestV0.4c.py as starting point
#                           - updated sensor port definitions - US is Input/port 1, Compass is US is Input/port 2
#                           - set IR as Input/port 3 but stubbed out all related code for now
#                           - removed motor 'polarity = 'inversed'
#                           - changed 'spd' to 5 during searchSLAM1 to slow the modified mechanical rotation
#
...
### Main Loop
    while (True):
        ...
        if usDistCmVal != prev_usDistCmVal:
            print("usDistCmVal = ", usDistCmVal, "  compassVal = ", compassVal)  # print all sensor vals, regardless of which changed
        ...
        if navPrint == 10:
            ...
            print("NAV:  x, spd, turnRatio, pilot_mode, searchSLAM1, cmpSearch, cmpGenHeading  ", x, spd, turnRatio, pilot_mode, searchSLAM1, cmpSearch, cmpGenHeading)
            navPrint = 0
        navPrint += 1
