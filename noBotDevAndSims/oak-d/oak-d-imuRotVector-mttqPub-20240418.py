...
# 4/18/2024     Ron King    - from file 'imu_rotation_vector-rjk5a.py'
#                           - initial dev to publish the oak-d imu_rotation_vector
#                             over mttq for consumption by subscriber(s)
#                           - the imu rotation data is available locally in several
#                             forms (quaternions, rotation matrix, Euler angles),
#                             but only published in Euler angles in this code
...
import oak_d_mttqPub_imuData_20240418 as mttqPub
...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        for imuPacket in imuPackets:
            ...
            mttqPub.publish_data(roll_x, pitch_y, yaw_z)
