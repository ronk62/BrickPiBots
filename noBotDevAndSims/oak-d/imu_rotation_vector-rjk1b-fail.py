...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        for imuPacket in imuPackets:
            ...
            w = rVvalues.real
            # x = rVvalues.i
            x = rVvalues.j  # swapped i with j
            # y = rVvalues.j
            y = rVvalues.i  # swapped j with i
            z = rVvalues.k
            ...
            # conv using function
            # (rjk, 6/25/2022) corrected for yaw and pitch based on experimentation in BPDDwasd... bot 
            yaw_y, pitch_z, roll_x = euler_from_quaternion(w, x, y, z) 

            print("RPY [deg]: roll_x: {0:.7f}, yaw_y: {1:.7f}, pitch_z: {2:.7f}".format(yaw_y, pitch_z, roll_x))
