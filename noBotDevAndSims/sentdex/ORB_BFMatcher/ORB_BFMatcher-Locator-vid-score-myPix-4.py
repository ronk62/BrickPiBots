...
# 11/20/2021    Ron King    - created from ORB_BFMatcher-Locator-vid-area-myPix-4
#                           - changed filter/selection to use combination of area and "squareness"
#                           - formula summary: Score = Area/(1 + sum of scene corner diffs squared)
#                           - highest score wins (should be the closest image match)
