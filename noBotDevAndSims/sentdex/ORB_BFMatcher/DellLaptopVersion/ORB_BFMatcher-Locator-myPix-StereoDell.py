...
plt.scatter(objX,xDiffs, label='objX,xDiffs', color='g', s=10, marker="o")
# for test...  plt.scatter(objY,yDiffs, label='objX,xDiffs', color='g', s=10, marker="o")
plt.axis('equal')
plt.xlabel('objX')
plt.ylabel('xDiffs')
plt.title('almost disperity - stereo data')
plt.legend()
plt.show()
