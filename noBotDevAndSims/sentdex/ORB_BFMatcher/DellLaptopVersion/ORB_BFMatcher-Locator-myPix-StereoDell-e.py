...
### added section to undistort images

# these are the previously captured calibration params
mtx = np.array([[596.80020541, 0., 315.34420529],[0., 598.60595689, 241.15112737],[0., 0., 1.]])

dist = np.array([0.191007,   -1.08328382, -0.00199661, -0.00299467,  1.90203655])
...
# cv.imwrite('calibresult.png', dst)    ### skip writing to filesystem for now
...
'''
# B = 10  # baseline = 10cm
B = 6.3  # baseline = 6.3cm  ...Shuttle Mechanism based frames
