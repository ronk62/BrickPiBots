...
tupscene = tuple(scene)

print("type(kp2) =  ", type(kp2))
print("type(scene) =  ", type(scene))
print("type(tupscene) =  ", type(tupscene))

print("kp2 =  ", kp2)

print("tupscene =  ", tupscene)

img3 = cv2.drawKeypoints(img1, tupscene, np.array([]))
# img3 = cv2.drawKeypoints(img1, kp1, np.array([]))
# img3 = cv2.drawKeypoints(img2, kp2, np.array([]))
plt.imshow(img3)
plt.show()
