...
#                           setup routine to circle and grab US dist measurements, saving the results in a list
#
# 6/7/2020      Ron King    revised to use compass renounted facing the front of the ML vehicle
#                           increased the number of distance data points at reduced angular difference
#
...
i = 0                   # iterator for dist point sampling
j = 0                   # another iterator for dist point sampling
        ...
        if pilot_mode < 0:
            ...
            ### new SLAM routine; initial 360 deg data capture
                ...
                if i == 0:
                    ...
                    # turn to compass val 10 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 2
                elif i == 2:
                    # turn to compass val 20 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 3
                elif i == 3:
                    # turn to compass val 30 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 4
                elif i == 4:
                    # turn to compass val 40 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 5
                elif i == 5:
                    # turn to compass val 50 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 6
                elif i == 6:
                    # turn to compass val 60 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 7
                elif i == 7:
                    # turn to compass val 70 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 8
                elif i == 8:
                    # turn to compass val 80 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 9
                elif i == 9:
                    # turn to compass val 90 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 10
                elif i == 10:
                    # turn to compass val 100 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 11
                elif i == 11:
                    # turn to compass val 110 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 12
                elif i == 12:
                    # turn to compass val 120 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 13
                elif i == 13:
                    # turn to compass val 130 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 14
                elif i == 14:
                    # turn to compass val 140 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 15
                elif i == 15:
                    # turn to compass val 150 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 16
                elif i == 16:
                    # turn to compass val 160 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 17
                elif i == 17:
                    # turn to compass val 170 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 18
                elif i == 18:
                    # turn to compass val 180 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 19
                elif i == 19:
                    # turn to compass val 190 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 20
                elif i == 20:
                    # turn to compass val 200 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 21
                elif i == 21:
                    # turn to compass val 210 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 22
                elif i == 22:
                    # turn to compass val 220 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 23
                elif i == 23:
                    # turn to compass val 230 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 24
                elif i == 24:
                    # turn to compass val 240 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 25
                elif i == 25:
                    # turn to compass val 250 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 26
                elif i == 26:
                    # turn to compass val 260 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 27
                elif i == 27:
                    # turn to compass val 270 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 28
                elif i == 28:
                    # turn to compass val 280 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 29
                elif i == 29:
                    # turn to compass val 290 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 30
                elif i == 30:
                    # turn to compass val 300 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 31
                elif i == 31:
                    # turn to compass val 310 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 32
                elif i == 32:
                    # turn to compass val 320 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 33
                elif i == 33:
                    # turn to compass val 330 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 34
                elif i == 34:
                    # turn to compass val 340 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 35
                elif i == 35:
                    # turn to compass val 350 +/- 3
                    if compassVal > ((i * 10) -3) and compassVal < ((i * 10) +3):
                        polarCoords.append(usDistCmVal)
                        print("appended polarCoords...  ", polarCoords, i)
                        i = 36                        
