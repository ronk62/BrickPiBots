...
### Main Loop
    while (True):
        ...
        if irProxVal != prev_irProxVal:
            print("irProxVal = ", irProxVal, "     compassVal = ", compassVal)  # print both sensor vals, regardless of which changed
        ...
        if irProxVal < 50:
            ...
            if pilot_mode < 0:
                ...
                mL.on(0, brake=False)
                mR.on(0, brake=False)
                print("Auto-pilot collision avoidance - resuming normal ops")
        ...
        if navPrint == 10:
            print("NAV:  x, spd, turnRatio, pilot_mode, beaconLock, cmpGenHeading, initSearch, beaconSearch, cmpSearch  ", x, spd, turnRatio, pilot_mode, beaconLock, cmpGenHeading, initSearch, beaconSearch, cmpSearch)
            navPrint = 0
        navPrint += 1
