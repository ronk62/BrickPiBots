...
#
# 6/8/2020      Ron King    refactored the searchSLAM1 section to remove repeated code
#                           modified ML vehicle to use castor wheels in back
#                           updated min and max turn ratios to -1 and +1 to allow pivot turns
#                           updated searchSLAM1 to use turn ratio -1 (pivot right turn)
#                           !!! This was a mechanical DISASTER - FAIL !!!
#                           !!! Moving now to Differential Drive Bot designs !!!
