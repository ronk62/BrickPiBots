...
while (1):
    ...
    # work-around for bogus intermittent readings of '0' (possibly a f/w bug in BrickPi3)
    if compassVal == 0 and abs(compassVal - prev_compassVal) > 1:
        badValCount += 1
        print("BAD compassVal = ", compassVal, "badValCount = ", badValCount, "  prev_compassVal (good value) = ", prev_compassVal)   # print for testing; comment for more 'normal' use
        compassVal = prev_compassVal    
